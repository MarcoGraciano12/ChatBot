...
from pruebas.prueba_rag import ChatSession

blp = Blueprint("Test", __name__, description="Test de funcionalidad.")
...
class ModelManager(MethodView):
    ...
    @blp.arguments(test_schema.PlainChangeModel)
    def post(self, data):
...
class CollectionManager(MethodView):
    ...
    @blp.arguments(test_schema.PlainChangeCategory)
    def post(self, data):
...
class DocumentesRecovered(MethodView):
    ...
    @blp.arguments(test_schema.PlainChangeK)
    def post(self, data):
        k = data["k"]
...
class DocumentesRecovered(MethodView):
    ...
    @blp.arguments(test_schema.PlainChangeLevel)
    def post(self, data):
        level = data["level"]
...
class RAGManager(MethodView):
    ...
    @blp.arguments(test_schema.PlainQueryCollection)
    def get(self, data):
        """
